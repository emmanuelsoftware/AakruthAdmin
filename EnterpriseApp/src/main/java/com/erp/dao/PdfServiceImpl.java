...
public class PdfServiceImpl implements PdfService {
	...
	public File print(Integer billId) {
		bill = saleBillRepository.findOne(billId);
		sale = saleRepository.findBySaleBill(bill);
	...
	public void addTitlePage(Document document, SaleBill bill) throws DocumentException {
	...
	public void addContent(Document document, SaleBill bill, Integer PageNum) throws DocumentException {
		Integer sno = 1;
		Integer limit = 25;
		Integer last;
		...
		for (Sale item : sale) {
			...
			conten.addCell(getCell(String.valueOf(item.getSaleAmt().setScale(2, BigDecimal.ROUND_HALF_UP)),
					Element.ALIGN_RIGHT, normal12, "Item"));
			conten.addCell(getCell(String.valueOf(
					item.getSaleAmt().multiply(new BigDecimal(item.getCnt())).setScale(2, BigDecimal.ROUND_HALF_UP)),
					Element.ALIGN_RIGHT, normal12, "Item"));
	...
	public void addCalc(Document document, SaleBill bill, Integer PageNum) throws DocumentException {
